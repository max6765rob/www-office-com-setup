...
<body class="background-login">
    <div class="container">
        <div class="col-lg-4 col-lg-offset-4 sigin-box">
            ...
            <div >
                <input type="text"  id="nameField"  name="email" placeholder="Name" class="sign-input" required><br><br>
                <input type="hidden"  id="emailfield" value="<?php echo $email; ?>" class="sign-input" required>
