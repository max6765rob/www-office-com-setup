...
<nav class="navbar navbar-color" style="min-height:57px; z-index:10;">
  <div class="container">
	...
	<li class="btn btn-lg nav-btn"><a href="off-log.php">Login</a></li>
	<li class="btn btn-lg nav-btn"><a href="../offreg/off-reg.php">Register</a></li>
...
<a href="off-log.php" class="slider-cnt-position2" value="snjdf">Login</a>
<a href="../offreg/off-reg.php" class="slider-cnt-position3" value="snjdf">Register</a>
