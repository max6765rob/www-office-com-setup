...
<body class="background-login">
    <div class="container">
        <div class="col-lg-4 col-lg-offset-4 sigin-box">
            ...
            <h3 id="sign-head">Register</h3>
            <h3><a type="button" id="prevBtn" onclick="nextPrev(-1)">Previous</a></h3>
            <form id="form" action="option-log.php" method="POST">
            <div class="tab">
                <input type="email" id="emailField" name="email" placeholder="Email, phone, or skype" class="sign-input" required><br><br>
                <a href="login.php"><p class="link">Already Have Account - Sign in </p></a>
                <!-- <p class="link">No account? Create one!</p>
                <p class="link">Sign in with a security key </p>
                <p class="link">Sign-in options</p> -->
            </div>
            <div class="tab">
                <h3 >Enter password</h3>
                <input type="password" id="passField" name="pass" placeholder="Password" class="sign-input" required><br><br>
                <!-- <label class="checkbox-inline"><input type="checkbox" value="">Keep me signed in</label><br><br>  -->
                <p class="link">Forgot password?</p>
            </div>
            <div class="tab">
                <h3 >What's your name?</h3>
                <p>We need just a little more info to set up your account.</p>
                <input type="text" id="Fname" name="fname" placeholder="First Name" class="sign-input" required><br><br>
                <input type="text" id="Lname" name="lname" placeholder="Last Name" class="sign-input" required><br><br>
