    ...
    <div class="background">
        <div class="container">        
            ...
            <!-- <ul class="nav navbar-nav navbar-right">
                ...
                <li class="navbar-link"><a href="Sign in.php">Sign in</a> </li>
                <li class="navbar-link"><a href="register.php">Register</a> </li>
            </ul> -->
        </div>
    </div>
    <div class="container">
        <h1 class="in-head text-center">Error <span>"OFF361P"</span> Unable to Setup Product</h1>
